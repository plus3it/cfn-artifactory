            ...
            steps {
                withCredentials(
                    ...
                    sh '''#!/bin/bash
                        ...
                        aws --region "${AwsRegion}" cloudformation delete-stack --stack-name "${CfnStackRoot}-SgRes" 
            ...
            steps {
                withCredentials(
                    ...
                    sh '''#!/bin/bash
                        ...
                        aws --region "${AwsRegion}" cloudformation create-stack --stack-name "${CfnStackRoot}-SgRes" \
                          --disable-rollback --capabilities CAPABILITY_NAMED_IAM \
                          --template-body file://Templates/make_artifactory_SGs.tmplt.json \
                          --parameters file://SecGrps.parms.json
